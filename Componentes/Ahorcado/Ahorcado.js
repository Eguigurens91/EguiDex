...
export default class Ahorcado extends Component {
  ...
  getPalabraAdivinar(){
    let PALABRAS = ["SEMINARIO", "UNICAH", "BETANCOURTH","HOLA","NATIVE","REACT","ADIOS"];
  ...
  sePulsoBoton(i){
    ...
    if(this.hayAcierto(letra)){
      botonesAux[i].estado = "Correcto";
      this.setState((prevState) => ({
        botones: botonesAux
      }));
    } else {
      botonesAux[i].estado = "Incorrecto";
      this.setState((prevState) => ({
        botones: botonesAux,
        ...
        <View style={styles.modalContainer}>
          <View style={styles.innerModalContainer}>
            ...
            <TouchableHighlight onPress={() => { this.reiniciar(); }}
                                style={styles.button}>
              <Text style={styles.textoBoton}>¿Juegas de nuevo? Pulsame !!</Text>
            </TouchableHighlight>
          </View>
        </View>
      </Modal>
